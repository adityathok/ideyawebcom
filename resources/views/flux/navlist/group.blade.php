...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-[#626260] hover:bg-[#ebe7e1] hover:text-[#111111] lg:h-8"
    >
        <div class="ps-3 pe-4">
    ...
    <div class="relative hidden space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute inset-y-[3px] start-0 ms-4 w-px bg-[#d3cec6]"></div>
...
<div {{ $attributes->class('block space-y-[2px]') }}>
    <div class="px-1 py-2">
        <div class="text-xs font-medium leading-none tracking-widest uppercase text-[#626260]">{{ $heading }}</div>
    </div>
