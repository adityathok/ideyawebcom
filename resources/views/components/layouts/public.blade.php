    ...
    <header
        ...
        <div
            ...
            <nav class="nav-fg hidden items-center gap-1 md:flex">
                ...
                <a href="{{ route('home') }}#layanan" class="rounded-lg px-3 py-2 text-sm font-medium text-[#65646e] hover:bg-[#f3f6ff] hover:text-[#100f12]">Layanan</a>
                ...
                <a href="#kontak" class="rounded-lg px-3 py-2 text-sm font-medium text-[#65646e] hover:bg-[#f3f6ff] hover:text-[#100f12]">Kontak</a>
            </nav>
            <div class="flex items-center gap-2">
                <a href="#kontak" class="nav-cta hidden rounded-lg bg-[#0a1589] px-[18px] py-[10px] text-[15px] font-medium leading-none text-white hover:bg-[#06105a] sm:inline-flex">Konsultasi Gratis</a>
            </div>
        </div>
    </header>
