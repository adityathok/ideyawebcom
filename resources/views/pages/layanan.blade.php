<x-layouts.public :seo-meta="$seoMeta">
    ...
    <x-page-hero breadcrumb="Layanan" :badge="'Layanan '.$company">
        <x-slot:title>Solusi website &amp; web app <span class="text-gradient-dark">dari ide sampai scale</span></x-slot:title>
        <x-slot:subtitle>Kami membangun website, aplikasi, dan integrasi yang cepat, aman, dan mudah dikembangkan — dari company profile hingga web app custom dan WordPress.</x-slot:subtitle>
        <x-slot:actions>
