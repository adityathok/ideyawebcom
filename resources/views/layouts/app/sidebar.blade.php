...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-[#f5f1ec] antialiased">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-[#d3cec6] bg-[#f5f1ec]">
            <flux:sidebar.header>
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Blog')" class="grid">
                    ...
                    <flux:sidebar.item icon="building-office" :href="route('admin.settings')" :current="request()->routeIs('admin.settings')" wire:navigate>
                        {{ __('Pengaturan') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
